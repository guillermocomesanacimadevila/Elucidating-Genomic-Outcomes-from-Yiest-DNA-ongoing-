...
def null_gene_counting(seq):
    null_gene_counter = 0
    stop_codons = ["UAA", "UAG", "UGA"]
    remaining_codons = [key for key, value in codon_aa_dictionary.items() if key != stop_codons]
    i = 0
...
print(null_gene_counting(RNA_FASTA_file))
